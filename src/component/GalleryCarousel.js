                ...
                <Carousel style={{ paddingLeft: 50, paddingRight: 50 }}>
                    <Carousel.Item  >
                        <Card className="text-danger">
                            ...
                            <Card.ImgOverlay>
                                <Card.Title ><h3>Ward & Other Rooms</h3></Card.Title>
                            </Card.ImgOverlay>
                        </Card>
                    </Carousel.Item>
                    <Carousel.Item>
                        <Card className="text-danger">
                            ...
                            <Card.ImgOverlay>
                                <Card.Title><h3>Operation & Surgery Theater</h3></Card.Title>
                            </Card.ImgOverlay>
                        </Card>
                    </Carousel.Item>
                    <Carousel.Item>
                        <Card className="text-danger">
                            ...
                            <Card.ImgOverlay>
                                <Card.Title><h3>CT Scan & MRI Center</h3></Card.Title>
                            </Card.ImgOverlay>
                        </Card>
                    </Carousel.Item>
                    <Carousel.Item>
                    ...
                    <Carousel.Item>
                        <Card className="text-danger">
                            ...
                            <Card.ImgOverlay>
                                <Card.Title className="text-danger"><h3>Heart Surgery Specialization Center</h3></Card.Title>
                            </Card.ImgOverlay>
                        </Card>
                    </Carousel.Item>
                </Carousel>
